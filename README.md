...
Le tri par fusion (ou merge sort) est un algorithme de tri efficace basé sur le principe « diviser pour régner ».
...
La phase de fusion est linéaire : on prend toujours le plus petit élément parmi les têtes des deux listes.
